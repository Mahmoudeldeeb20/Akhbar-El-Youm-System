$(document).ready(function() {
        ...
        $('#profile_info').on('click', function() {
                ...
                $('#profile_info_content').fadeIn().siblings().css('display', 'none');
        });
        $('#profile_subject').on('click', function() {
                $(this).addClass('active').siblings().removeClass('active');
                $('#profile_subject_content').fadeIn().siblings().css('display', 'none');
        });
        $('#profile_grades').on('click', function() {
                $(this).addClass('active').siblings().removeClass('active');
                $('#profile_grades_content').fadeIn().siblings().css('display', 'none');
        });
        $('#profile_attendance').on('click', function() {
                $(this).addClass('active').siblings().removeClass('active');
                $('#profile_attendance_content').fadeIn().siblings().css('display', 'none');
        });
        $('#profile_lecture').on('click', function() {
                $(this).addClass('active').siblings().removeClass('active');
                $('#profile_lecture_content').fadeIn().siblings().css('display', 'none');
        });
        $('#profile_password').on('click', function() {
                $(this).addClass('active').siblings().removeClass('active');
                $('#profile_password_content').fadeIn().siblings().css('display', 'none');
        });
        // ## End Mahmoud Hamdy ##
        // ## Start Kareem Adel ##
